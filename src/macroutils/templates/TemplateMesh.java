...
public class TemplateMesh {
     ...
     * <ol>
     * <li> Creates a Block Part with 6 Part Surfaces inside, i.e., x0, x1, y0, y1, z0 and z1. The
     * default Tessellation option is used. See {@link UserDeclarations#defTessOpt};
     ...
     * @param u      given Units.
     * @param nCells given 3-components array with Directed Mesher cells in X, Y and Z,
     *               respectively. E.g.: {10, 5, 4}.
     ...
     * This method will do the following:
     * <ol>
     * <li> Creates a Cylinder Part with 3 Part Surfaces inside, i.e., x0, x1, and Default, assuming
     * the extrusion happened in the X axis. The default Tessellation option is used. See
     ...
     *               options.
     * @param nCells given 3-components array with Directed Mesher cells in Theta, Radius and
     *               Length, respectively. E.g.: {5, 10, 20}.
     * @param rR     given r/R distance for the O-Grid. E.x.: 0.5;
     * @param name   given name for the Part and Region.
     * @param vo     given verbose option. False will not print anything.
     * @return The generated Region.
     */
    public Region hexaCylinder(double r, double l, double[] org, Units u, 
            StaticDeclarations.Axis ax, int[] nCells, double rR, String name, boolean vo) {
        ...
        _add.meshOperation
                .directedMeshing_Pipe(src, tgt, nCells[0], nCells[1], nCells[2], rR, ccs).execute();
        return reg;
    }

    /**
     * When using this template, use this option to Badge it as 2D before generating the mesh.
     * Default = false.
     *
