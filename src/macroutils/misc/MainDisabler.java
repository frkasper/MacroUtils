...
public class MainDisabler {
    ...
    /**
     * Disables the Thin Layer Mesher for all Fluid Regions belonging to the Automated Mesh
     * Operation.
     *
     * @param amo given AutoMeshOperation.
     */
    public void thinLayersOnFluids(AutoMeshOperation amo) {
        ...
        for (Region r : _sim.getRegionManager().getRegions()) {
            ...
            PartsCustomizeThinMesh pctm = pcmc.getCustomConditions()
                    .get(PartsCustomizeThinMesh.class);
