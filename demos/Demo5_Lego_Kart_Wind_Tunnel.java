...
public class Demo5_Lego_Kart_Wind_Tunnel extends StarMacro {
    ...
    private void prep2_createTunnelWrapAndRegion() {
        ...
        ud.mshCtrl1 = mu.add.meshOperation.surfaceControl(ud.wrapMshOp, ud.geometryObjects2, 0., targetTunnel);
        ...
        for (int i = 0; i < volumeControls.length; i++) {
            ...
            ud.mshCtrl = mu.add.meshOperation.volumetricControl(ud.mshOp, ud.geometryParts2, relativeSize);
    ...
    private void prep4_setPost() {
        ...
        mu.add.solver.stoppingCriteria(ud.mon1, StaticDeclarations.StopCriteria.ASYMPTOTIC, 0.002, 50);
        mu.add.solver.stoppingCriteria(ud.mon2, StaticDeclarations.StopCriteria.ASYMPTOTIC, 0.002, 50);
        // mu.saveSim("prep4");
    }
