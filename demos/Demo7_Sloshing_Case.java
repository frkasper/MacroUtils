...
public class Demo7_Sloshing_Case extends StarMacro {
    ...
    void prep1_createRegion() {
        ud.defCamView = mu.io.read.cameraView("myView|4.478788e-02,4.233814e-02,1.889347e-03|4.478788e-02,4.233814e-02,2.732051e-01|0.000000e+00,1.000000e+00,0.000000e+00|5.817755e-02|1", true);
        ud.cadPrt = mu.add.geometry.block3DCAD(StaticDeclarations.COORD0, new double[]{L, H, W}, ud.unit_mm);
        ud.partSrf = mu.set.geometry.combinePartSurfaces(mu.get.partSurfaces.allByREGEX("z.*", true), true);
    ...
    void prep2_PhysicsAndMesh() {
        ...
        ud.mshOp = mu.add.meshOperation.automatedMesh(ud.geometryParts, StaticDeclarations.Meshers.TRIMMER_MESHER);
    ...
    void prep3_MotionAndPost() {
        ...
        mu.add.scene.annotation(ud.scene, (ReportAnnotation) mu.get.objects.annotation("Time", true),
