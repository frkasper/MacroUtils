...
public class Demo4_Split_Part_Surfaces extends StarMacro {
    ...
    private void importGeometryAndSplitPartSurfaces() {
        ...
        mu.set.geometry.splitPartSurfacesByAngle(mu.get.partSurfaces.all(ud.geomPrt, true),
                70, true);
        ...
        //--
        ud.partSrf2 = mu.get.partSurfaces.byAreaMin(
                mu.get.partSurfaces.allByREGEX(ud.geomPrt, "Faces.*", true));
        ...
        mu.set.geometry.combinePartSurfaces(ud.partSurfaces2, true)
                .setPresentationName("blade tips");
